...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.image'
        db.add_column('skills_skill', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='defaultimage', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.image'
        db.delete_column('skills_skill', 'image')
    ...
    models = {
        ...
        'skills.skill': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'defaultimage'", 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'training_bits': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'to': "orm['skills.TrainingBit']", 'null': 'True'})
        },
        'skills.trainingbit': {
