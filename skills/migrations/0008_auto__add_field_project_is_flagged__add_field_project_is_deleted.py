...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_flagged'
        db.add_column('skills_project', 'is_flagged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.is_deleted'
        db.add_column('skills_project', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.is_flagged'
        db.delete_column('skills_project', 'is_flagged')

        # Deleting field 'Project.is_deleted'
        db.delete_column('skills_project', 'is_deleted')
    ...
    models = {
        ...
        'global_change_lab.user': {
            ...
            'skills_completed': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'users_completed'", 'symmetrical': 'False', 'to': "orm['skills.Skill']", 'blank': 'True'}),
            'skills_in_progress': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'users_in_progress'", 'symmetrical': 'False', 'to': "orm['skills.Skill']", 'blank': 'True'}),
            'trainingbits_completed': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'users_completed'", 'symmetrical': 'False', 'to': "orm['skills.TrainingBit']", 'blank': 'True'}),
            'trainingbits_in_progress': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'users_in_progress'", 'symmetrical': 'False', 'to': "orm['skills.TrainingBit']", 'blank': 'True'}),
        ...
        'skills.project': {
            ...
            'updated_at': ('skills.models.AutoDateTimeField', [], {}),
            'video': ('embed_video.fields.EmbedVideoField', [], {'blank': 'True', 'max_length': '200', 'null': 'True'})
        },
        'skills.skill': {
