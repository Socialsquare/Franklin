...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrainingBit.is_recommended'
        db.add_column('skills_trainingbit', 'is_recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Skill.is_recommended'
        db.add_column('skills_skill', 'is_recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        if not db.dry_run:
            for obj in orm.TrainingBit.objects.all():
                obj.is_recommended = obj.recommended
                obj.save()


    def backwards(self, orm):
        # Deleting field 'TrainingBit.is_recommended'
        db.delete_column('skills_trainingbit', 'is_recommended')

        # Deleting field 'Skill.is_recommended'
        db.delete_column('skills_skill', 'is_recommended')

        if not db.dry_run:
            for obj in orm.TrainingBit.objects.all():
                obj.recommended = obj.is_recommended
                obj.save()
