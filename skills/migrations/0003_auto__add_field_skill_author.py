...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('skills_skill', 'author',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('skills_skill', 'author_id')
    ...
    models = {
        ...
        'skills.skill': {
            ...
            'training_bits': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'to': "orm['skills.TrainingBit']", 'null': 'True'})
        },
        'skills.trainingbit': {
