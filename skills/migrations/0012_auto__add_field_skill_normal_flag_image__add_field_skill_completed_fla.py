...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.normal_flag_image'
        db.add_column('skills_skill', 'normal_flag_image',
                      self.gf('django.db.models.fields.files.ImageField')(blank=True, null=True, max_length=100),
                      keep_default=False)

        # Adding field 'Skill.completed_flag_image'
        db.add_column('skills_skill', 'completed_flag_image',
                      self.gf('django.db.models.fields.files.ImageField')(blank=True, null=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.normal_flag_image'
        db.delete_column('skills_skill', 'normal_flag_image')

        # Deleting field 'Skill.completed_flag_image'
        db.delete_column('skills_skill', 'completed_flag_image')
    ...
    models = {
        ...
        'global_change_lab.user': {
            ...
            'skills_completed': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'related_name': "'users_completed'", 'to': "orm['skills.Skill']"}),
            'skills_in_progress': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'related_name': "'users_in_progress'", 'to': "orm['skills.Skill']"}),
            'trainingbits_completed': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'related_name': "'users_completed'", 'to': "orm['skills.TrainingBit']"}),
            'trainingbits_in_progress': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'related_name': "'users_in_progress'", 'to': "orm['skills.TrainingBit']"}),
        ...
        'skills.skill': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['global_change_lab.User']"}),
            'completed_flag_image': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            ...
            'normal_flag_image': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '60'}),
